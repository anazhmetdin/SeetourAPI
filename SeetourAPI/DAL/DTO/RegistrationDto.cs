...
{
    public record CustomerRegistrationDto(string UserName, string Password,string profilepic, string SSN, string FullName,string PhoneNumber,string SecurityLevel);
